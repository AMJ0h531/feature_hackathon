...
public class DataInitializer implements CommandLineRunner {
    ...
    private void createTask(String title, String description, TaskStatus status, String createdBy) {
        Task task = new Task();
        task.setTitle(title);
